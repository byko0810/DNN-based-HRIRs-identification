...
xsmooth = zeros(ss, T, 'gpuArray');
Vsmooth = zeros(ss, ss, T, 'gpuArray');
VVsmooth = zeros(ss, ss, T, 'gpuArray');

% Forward pass
[xfilt, Vfilt, VVfilt, loglik] = kalman_filter_GPU(y, A, C, Q, R, init_x, init_V, ...
					       'model', model, 'u', u, 'B', B);
...
VVsmooth(:,:,1) = zeros(ss,ss, 'gpuArray');
